...
public class RecursiveSorts
{
   ...
   /*
   * Comparator for String Array MergeSort
   * @return compare 
   */
   private static int compareTo(String a, String b)
   {
         int compare = a.compareTo(b); // compares two string and stores value (0 or -1 or 1 ) 
         if ( compare != 0 )  // If not equal on this component, so compare on this.
            return compare; // return value of compare when it is not 0 
         else
         {
             return 0;// return 0 
         }
                     ...
                     int end)
   {
      ...
      while (index1 <= middle && index2 <= end)
      {
         //if (numbers[index1] < numbers[index2])
          if (compareTo(numbers[index1],numbers[index2]) < 0) // Performs compareTo comparator. 
         {
